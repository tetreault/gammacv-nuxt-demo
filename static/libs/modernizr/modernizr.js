window.Modernizr = (function(e, t, n) {
  ...
  function l() {
    (p.input = (function(n) {
      for (let r = 0, o = n.length; o > r; r++) j[n[r]] = !!(n[r] in E);
      return (
        j.list &&
  ...
  var d,
    ...
    z = function(t) {
      let n = e.matchMedia || e.msMatchMedia;
    ...
    (M.fontface = function() {
      ...
      return (
        F('@font-face {font-family:"font";src:url("https://")}', function(
          ...
          let o = t.getElementById("smodernizr"),
            ...
            i = a
              ? a.cssRules && a.cssRules[0]
                ...
                : a.cssText || ""
              : "";
          e = /src/i.test(i) && i.indexOf(r.split(" ")[0]) === 0;
        }),
        e
      );
    }),
  ...
  return (
    ...
    (p.addTest = function(e, t) {
      if (typeof e === "object") for (let r in e) f(e, r) && p.addTest(r, e[r]);
      else {
